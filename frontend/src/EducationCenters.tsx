...
/**The application starts on the top position */
    useEffect(() => {
      window.scrollTo(0, 0);
    }, []);
/**Creating state visibiliti for the buttoms intructions in order to hide/show the text */
    ...
    const toggleVisibility = (stepNumber) => {
      switch (stepNumber) {
        ...
        case 2:
          ...
          break;
        case 3:
          setIsVisibleStep3(!isVisibleStep3);
          break;
        default:
          break;
      }
    ...
    return (
        <div className="container-education-centers">
            <div className='partners-title' data-testid="educationCenters-page-title">
                <p>Education Centers</p>
            </div>
            ...
            <div className="education-box-2">
                    ...
                    <br />
                <div className="conatiner-text-content">
                    <div className='steps'>

                        <div>
                        <button className="header-content-steps" onClick={() => toggleVisibility(1)}>
                            {isVisibleStep1 ? 'Step 1' : 'Step 1'}
                        </button>
                        {isVisibleStep1 && <div className='steps'><p>For education centers</p>
                        <br />
                    ...
                    <div className='steps'>
                        ...
                        <div>
                        <button className="header-content-steps" onClick={() => toggleVisibility(2)}>
                            {isVisibleStep2 ? 'Step 2' : 'Step 2'}
                        </button>
                        {isVisibleStep2 &&    <div className='steps'>
                    ...
                    <div className='steps'>
                        ...
                        <div >
                        <button className="header-content-steps"  onClick={() => toggleVisibility(3)}>
                            {isVisibleStep3 ? 'Step 3' : 'Step 3'}
                        </button>
                        {isVisibleStep3 && <div className='steps' >
