...
function Tutors() {
    ...
    const tutors = [
        ...
        {image: "/src/assets/boat-icon.png", name: "Rostislav", completedVehicles: "0.5", isEstimate: false, isCertified: false, tutorId: 3},
    ]
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="mt-16">
                                    ...
                                    <p className="text-center text-gray-600 text-base pt-3 font-normal px-6">Completed vehicles: {tutor.completedVehicles}{tutor.isEstimate ? "+" : ""}</p>
